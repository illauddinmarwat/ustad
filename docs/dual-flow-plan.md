...
**Status: implemented 2026-09-21 (not yet pushed/deployed).** Deviations are noted inline. The feature flag is seeded `false`; enable with `update app_settings set value = 'true' where key = 'direct_requests_enabled'`.
...
**Status: implemented 2026-09-21 (not yet pushed/deployed).** Deviations noted inline.
...
**Status: implemented 2026-09-21 (not yet pushed/deployed).** Deviations noted inline. Flag `job_posting_enabled` ships off.
...
**Status: implemented 2026-09-21 (not yet pushed/deployed).** Deviations noted inline. Built on the assumed defaults in Follow-up Q-H/Q-J (7 / 7 / 14 days; 15% of the confirmed receipt amount); Q-I (how workers pay) is handled by letting the admin record any method.
